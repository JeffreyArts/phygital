<template>
    <div class="surface-dimensions-section" ref="container">
        ...
        <div class="surface-dimensions">
            <aztech-input-number v-model="width" :disabled="!app.editMode" min="2" :max="app.maxSurfaceWidth.toString()" label="width" @update="modifyWidth" @increase="modifyWidth" @decrease="modifyWidth"/>
            <aztech-input-number v-model="height" :disabled="!app.editMode" min="2" :max="app.maxSurfaceHeight.toString()" label="height" @update="modifyHeight" @increase="modifyHeight" @decrease="modifyHeight"/>
        </div>
