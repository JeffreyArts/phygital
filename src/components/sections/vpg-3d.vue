...
export default {
    ...
    watch: {
        "phygital.surfaces.top.polylines": {
            handler() {
                console.log("Update polylines top")
    ...
    methods: {
        ...
        updateModelSurface(surfaceSide: "top" | "bottom" | "left" | "right" |  "front" | "back") {
            ...
            if (surfaceSide === "top") {
                console.log("updateModelSurface", surfaceSide)
            ...
            if (surfaceSide === "back") {
                ...
                mergedObject.position.x = surface.width/2 + diameter/2
                // mergedObject.position.x = -diameter/2
                mergedObject.position.y = surface.height
                mergedObject.updateMatrix()
            }
            ...
            if (surfaceSide === "right") {
                ...
                mergedObject.rotateX(Math.PI/180* 90)
                mergedObject.rotateZ(Math.PI/180* 90)
                mergedObject.position.z = surfaces.right.width /2 + diameter/2
                mergedObject.position.x = surfaces.front.width / 2
                mergedObject.position.y = surface.height
                mergedObject.updateMatrix()
            }
                
            this.model.children.forEach( g => {
